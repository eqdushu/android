...
public class ConfigInfoActivity extends InstrumentedActivity implements OnClickListener{
	...
	private void initView(){
		...
		String udid =  DeviceInfoUtil.getImei(getApplicationContext(), "");
        if (null != udid) mImei.setText("IMEI: " + udid);

		TextView mAppKey = (TextView) findViewById(R.id.tv_appkey);
		String appKey = DeviceInfoUtil.getAppKey(getApplicationContext());
		...
		String deviceId = DeviceInfoUtil.getDeviceId(getApplicationContext());
		TextView mDeviceId = (TextView) findViewById(R.id.tv_device_id);
		mDeviceId.setText("deviceId:" + deviceId);

		String versionName =  DeviceInfoUtil.GetVersion(getApplicationContext());
	...
	public void onClick(View v) {
		...
		case R.id.init:
			...
			break;
		case R.id.setting:
			//Intent intent = new Intent(ConfigInfoActivity.this, PushSetActivity.class);
	...
	public static final String MESSAGE_RECEIVED_ACTION = "com.tmacbo.eqdushu.test.MESSAGE_RECEIVED_ACTION";
		...
		public void onReceive(Context context, Intent intent) {
			try {
				if (MESSAGE_RECEIVED_ACTION.equals(intent.getAction())) {
					...
					if (!DeviceInfoUtil.isEmpty(extras)) {
