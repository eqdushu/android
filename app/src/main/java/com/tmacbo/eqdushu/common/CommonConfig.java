...
public class CommonConfig {
    ...
    public static void init(@NonNull Context context) {
        ...
        try {
            ...
            //获取包名
            CommonConfig.ONLINE_PACKAGE_NAME = metaData.getString("JPUSH_PKGNAME");
            //获取证书MD值
            CommonConfig.ONLINE_SIGN_MD5 = metaData.getString("EQDUSHU_SIGN_MD5");
            //获取UMENG的KEY
            CommonConfig.ONLINE_UMENG_KEY = metaData.getString("EQDUSHU_ONLINE_UMENG_KEY");
            //获取极光的KEY
            CommonConfig.ONLINE_JPUSH_KEY = metaData.getString("EQDUSHU_ONLINE_JPUSH_KEY");
            //高德地图
            ...
            //获取服务器地址
            BASE_URL_DEBUG = metaData.getString("EQDUSHU_BASE_URL_TEST");
            BASE_URL_ONLINE = metaData.getString("EQDUSHU_BASE_URL_ONLINE");
            ...
            CLIENT_ID =
                TextUtils.isEmpty(CLIENT_ID) ? "AA89D6D64FB94F79B4A8060165A41A51" : CLIENT_ID;
            //设置加密编号
    ...
    public static void setCHANNEL(Context context, String CHANNEL) {
        SharedPreferences.Editor editor =
            context.getSharedPreferences("Demo", Context.MODE_PRIVATE).edit();
