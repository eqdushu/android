package com.tmacbo.eqdushu.common.widget;
...
import com.tmacbo.eqdushu.common.ViewUtils;
...
public class RecyclerViewPager extends RecyclerView {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTriggerOffset = a.getFloat(R.styleable.RecyclerViewPager_rvp_triggerOffset, 0.15f);
